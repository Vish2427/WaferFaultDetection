...
class prediction:
    ...
    def predictionFromModel(self):
        ...
        try:
            ...
            self.log_writer.log(self.log_file,'Start of Prediction')
            data_getter=data_loader_prediction.Data_Getter_Pred(self.log_file,self.log_writer)
            ...
            #data=data.to_numpy()
            file_loader=file_methods.File_Operation(self.log_file,self.log_writer)
            ...
            self.log_writer.log(self.log_file,'End of Prediction')
        except Exception as ex:
            self.log_writer.log(self.log_file, 'Error occured while running the prediction!! Error:: %s' % ex)
            raise ex
