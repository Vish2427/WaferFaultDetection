...
class pred_validation:
    ...
    def prediction_validation(self):
        ...
        try:
            ...
            self.log_writer.log(self.log_file, 'Start of Validation on files for prediction!!')
            ...
            self.log_writer.log(self.log_file, "Creating Prediction_Database and tables on the basis of given schema!!!")
            #create database with given name, if present open the connection! Create table with columns given in schema
            self.dBOperation.createTableDb('Prediction','Good Data')
            ...
            self.dBOperation.insertIntoTableGoodData('Prediction', 'Good Data')
            ...
            self.dBOperation.selectingDatafromtableintocsv('Prediction','Good Data')
