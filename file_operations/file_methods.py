...
class File_Operation:
   ...
   and load the saved model for prediction.
    ...
    def save_model(self,model,filename):
        ...
        """
        self.logger_object.log(self.log_file, 'Entered the save_model method of the File_Operation class')
        try:
            ...
            self.logger_object.log(self.log_file,'Exception occured in save_model method of the Model_Finder class. Exception message:  ' + str(e))
            self.logger_object.log(self.log_file,
    ...
    def load_model(self,filename):
        ...
        """
        self.logger_object.log(self.log_file, 'Entered the load_model method of the File_Operation class')
        try:
    ...
    def find_correct_model_file(self,cluster_number):
        ...
        On Failure: Raise Exception
        """
        self.logger_object.log(self.log_file, 'Entered the find_correct_model_file method of the File_Operation class')
        try:
